...
public class EspecieController implements Serializable {
	...
	@EJB
	private br.unioeste.persistencia.EspecieFacade ejbFacade;
	...
	public static class EspecieControllerConverter implements Converter {
		...
		public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
			...
			if (object instanceof Especie) {
				...
				throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + EspecieController.class.getName());
			}
		}
	}
}
