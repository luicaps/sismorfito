...
public class GeneroController implements Serializable {
	...
	@EJB
	private br.unioeste.persistencia.GeneroFacade ejbFacade;
	...
	public static class GeneroControllerConverter implements Converter {
		...
		public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
			...
			if (object instanceof Genero) {
				...
				throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + GeneroController.class.getName());
			}
		}
	}
}
