...
public class CidadeController implements Serializable {
	...
	@EJB
	private br.unioeste.persistencia.CidadeFacade ejbFacade;
	...
	public static class CidadeControllerConverter implements Converter {
		...
		public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
			...
			if (object instanceof Cidade) {
				...
				throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + CidadeController.class.getName());
			}
		}
	}
}
