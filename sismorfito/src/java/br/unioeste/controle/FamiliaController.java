...
public class FamiliaController implements Serializable {
	...
	@EJB
	private br.unioeste.persistencia.FamiliaFacade ejbFacade;
	...
	public static class FamiliaControllerConverter implements Converter {
		...
		public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
			...
			if (object instanceof Familia) {
				...
				throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + FamiliaController.class.getName());
			}
		}
	}
}
